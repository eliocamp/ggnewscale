...
$<$em$>$Vitis$<$/Em$>$ - ProQuest*.
[https://www.proquest.com/openview/34d303f27deac557b3314eb9887b8ca9/1.pdf?pq-origsite=gscholar&cbl=18750&diss=y#page=34](https://www.proquest.com/openview/34d303f27deac557b3314eb9887b8ca9/1.pdf?pq-origsite=gscholar&cbl=18750&diss=y%5C#page=34).
...
and its aliases
[`new_scale_color()`](https://eliocamp.github.io/ggnewscale/reference/new_scale.md)
and
[`new_scale_fill()`](https://eliocamp.github.io/ggnewscale/reference/new_scale.md).
When added to a plot, every geom added after them will use a different
scale.
